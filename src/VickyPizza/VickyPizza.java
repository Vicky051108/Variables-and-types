...
public class VickyPizza {
    ...
    public VickyPizza(String name, String address, String email, String phone, String menu, String ingredients, double price, String side, String drink, int orderID, double orderTotal, String cardNumber, String expiryDate, int cvv) {
        this.storeName = name;
